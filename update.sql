--
-- Script to update the database with new data, using systems_recently.csv and bodies7days.json
-- Also requires the ed_import_schema.sql file
--

-- Add import tables
SOURCE ed_import_schema.sql;
DROP TABLE commodities_import,factions_import,listings_import,modules_import,stations_import;
...
-- Cleanup import data
DROP TABLE systems_import,bodies_import;
